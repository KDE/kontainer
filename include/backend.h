...
private:
    ...
    const QStringList DISTROS = {
        "alma", "alpine", "amazon", "arch", "bazzite", "blackarch", "bluefin",
        "bookworm", "bullseye", "buster", "centos", "chainguard", "clearlinux",
        "crystal", "debian", "deepin", "fedora", "gentoo", "kali", "leap",
        "linuxmint", "mageia", "neon", "neurodebian", "opensuse", "oracle",
        "plasma", "powershell", "redhat", "rhel", "rocky", "slackware",
        "steamos", "toolbox", "tumbleweed", "ubi", "ublue", "ubuntu",
        "vanilla", "void", "wheezy", "wolfi"
    };

    QMap<QString, QString> distroIconMap = {
        // Official distros
        {"alma", "almalinux.svg"},
        {"alpine", "alpine.svg"},
        //{"amazon", "amazon.svg"},
