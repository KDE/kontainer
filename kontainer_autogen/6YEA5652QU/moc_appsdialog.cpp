/****************************************************************************
** Meta object code from reading C++ file 'appsdialog.h'
**
...
#error "The header file 'appsdialog.h' doesn't include <QObject>."
...
template<>
constexpr inline auto AppsDialog::qt_create_metaobjectdata<qt_meta_tag_ZN10AppsDialogE_t>()
{
    namespace QMC = QtMocConstants;
    QtMocHelpers::StringRefStorage qt_stringData{"AppsDialog"};

    QtMocHelpers::UintData qt_methods{};
    QtMocHelpers::UintData qt_properties{};
    QtMocHelpers::UintData qt_enums{};
    return QtMocHelpers::metaObjectData<AppsDialog, qt_meta_tag_ZN10AppsDialogE_t>(QMC::MetaObjectFlag{}, qt_stringData, qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject AppsDialog::staticMetaObject = {{QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
